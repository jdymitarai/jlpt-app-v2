...
const subCategories = [
  ...
  { id: "med_basic", label: "基礎醫學：生理學、病理學、藥理學、微生物學與免疫學", group: "clinical_medical" },
  { id: "med_nursing", label: "基本護理學及護理行政：護理原理、護理技術及護理行政", group: "clinical_medical" },
  { id: "med_medsurg", label: "內外科護理學", group: "clinical_medical" },
  { id: "med_pedsmats", label: "產兒科護理學：產科護理學、兒科護理學", group: "clinical_medical" },
